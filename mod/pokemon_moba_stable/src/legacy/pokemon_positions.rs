...
use crate::legacy::pokemon_strategy::{
    has_trait, shared_trait_count, strategy_for_champion_id, StrategyTrait,
};
use crate::legacy::pokemon_types::total_modifier_ratio;
...
fn move_weight(pokemon_move: PokemonMove) -> f32 {
    match pokemon_move.slot {
        crate::legacy::pokemon_content::ActionSlot::Attack => 0.55,
        crate::legacy::pokemon_content::ActionSlot::Skill => 1.0,
        crate::legacy::pokemon_content::ActionSlot::Skill2 => 0.9,
        crate::legacy::pokemon_content::ActionSlot::Ult => 0.75,
    }
}
