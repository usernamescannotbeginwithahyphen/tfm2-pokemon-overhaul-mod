...
use crate::stable_legacy_api::{ClientData, ModServerExtension, ServerModContext};

use crate::legacy::pokemon_status::{
...
fn log_stat_merge_tick(snapshot_count: usize, snapshots: &[PokemonCombatStatSnapshot]) {
    ...
    write_stat_merge_log(&format!(
        ...
        crate::legacy::crash_probe::sanitize_log_field(&summary),
        crate::legacy::crash_probe::sanitize_log_field(&rows),
        crate::legacy::crash_probe::sanitize_log_field(&identity_rows),
    ));
}
